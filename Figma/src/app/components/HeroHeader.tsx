      ...
      <div className="relative">
        ...
        <div className="mb-6 relative">
          ...
          <div className="relative bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-500 rounded-2xl py-4 px-6 border-4 border-yellow-300 shadow-2xl shadow-yellow-500/50 animate-pulse">
            ...
            <div className="text-5xl md:text-7xl font-black text-yellow-900 tracking-tight" style={{ fontFamily: 'Bebas Neue, sans-serif', textShadow: '2px 2px 0px rgba(0,0,0,0.1)' }}>
              WIN $250
            </div>
        ...
        {/* <div className="inline-flex flex-col items-center gap-2 px-6 py-3 mb-4 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full border border-purple-500/30">
          ...
          {timeLeft && (
            <div className="text-xl font-bold text-yellow-400" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
              {timeLeft}
            </div>
          )}
        </div> */}
        
        <h1 className="text-6xl md:text-7xl mb-4 tracking-tight" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
        ...
        <div className="mt-8 max-w-3xl mx-auto">
          <h3 className="text-2xl md:text-3xl text-yellow-400 mb-4 font-bold" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
            💰 Pricing 💰
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-center">
            {/* Individual */}
            <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 rounded-xl p-4 border border-purple-500/30">
              <p className="text-white text-lg font-bold mb-1" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                Single Number
              </p>
              <p className="text-yellow-400 text-3xl font-black" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                $25
              </p>
            ...
            {/* Best Deal - 5 Numbers */}
            <div className="bg-gradient-to-r from-green-900/50 to-emerald-900/50 rounded-xl p-4 border-2 border-green-400/50 relative overflow-hidden">
              <div className="absolute top-2 right-2 bg-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                Most Popular
              </div>
              <p className="text-white text-lg font-bold mb-1" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                5 Numbers (1 Free)
