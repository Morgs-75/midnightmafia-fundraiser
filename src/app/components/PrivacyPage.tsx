      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="text-gray-300 text-sm space-y-6 leading-relaxed" style={{ fontFamily: "Poppins, sans-serif" }}>
          ...
          <section>
            ...
            <p>This Privacy Policy explains how personal information is handled in connection with the Midnight Mafia Numbers Board Fundraiser (the Fundraiser).</p>
            <p className="mt-2">The Fundraiser is organised by Troy Morgan (the Organiser), acting solely as a volunteer to assist with fundraising for the cheerleading team Midnight Mafia (of Outlaws) (the Team).</p>
            <p className="mt-2">The Organiser has no financial interest in the outcome of the Fundraiser and holds all funds raised solely for the benefit of the Team Members participating in The Cheerleading Worlds in April 2026.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">No personal information is collected via website forms or direct communication unless required to administer the Fundraiser or pay the prize.</p>
            <p className="mt-2">The Organiser does not collect, store, process, or have access to any credit card or payment card details at any time. All payment card information is handled exclusively by Stripe.</p>
          </section>
          ...
          <section>
            ...
            <p>Participants may request access to or correction of their personal information by contacting the Organiser.</p>
          </section>
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 flex flex-wrap gap-4 text-sm" style={{ fontFamily: "Poppins, sans-serif" }}>
          <a href="/terms-of-service" className="text-purple-400 hover:text-purple-300 underline underline-offset-2 transition-colors">Terms of Service</a>
