...
const POPUP_CONFIGS = [
  {
    ...
    message: "Secure your numbers before they're gone!",
    countdown: 60
  },
  {
    type: "alert" as const,
    title: "🔥 DON'T MISS OUT!",
    message: "Numbers are selling fast!",
    countdown: 55
  },
  {
    type: "alert" as const,
    title: "⚡ DON'T MISS OUT!",
    message: "Get your lucky numbers now!",
    countdown: 50
  },
  {
    type: "alert" as const,
    title: "💎 DON'T MISS OUT!",
    message: "Pick your favorites while you can!",
    countdown: 65
  },
  {
    type: "alert" as const,
            ...
            <div className="relative">
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  <h3 className="text-xl text-white font-black mb-1" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 800 }}>
                    {popup.title}
                  </h3>
              ...
              {countdown > 0 && (
                ...
                >
                  ...
                  <p className="text-3xl text-white font-black" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 900 }}>
