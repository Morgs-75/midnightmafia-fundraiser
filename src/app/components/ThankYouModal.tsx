                  ...
                  {showContent && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="mt-3 pb-1"
                      >
                        <p className="text-purple-200 text-xs mb-1.5 font-semibold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                          📱 Share Your Support
                        </p>
                        <div className="flex gap-1.5 justify-center flex-nowrap">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-9 h-9 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Instagram"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Facebook"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-9 h-9 bg-black rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Twitter/X"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-9 h-9 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="WhatsApp"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-9 h-9 bg-gray-700 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Copy Link"
                          >
